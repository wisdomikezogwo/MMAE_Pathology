...
def vit_to_multimae(multimae_state_dict):
    """
    Converts timm ViT weights to MultiMAE_olde weights.
    """
    state_dict = {}
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(prog="ViT to MultiMAE_olde checkpoint converter")
    parser.add_argument(
    ...
    print('Converting from ViT weights to MultiMAE_olde weights...')
